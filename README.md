...
| Home/Logistics Screen | Login Screen                          | 
|-----------------------|--------------------------------------|
| Central hub for managing your trip. | Central hub for managing your trip. |
|  ![Home Screen](./homelogisticsscreen.png) | ![Home Screen](./homelogisticsscreen.png) |
